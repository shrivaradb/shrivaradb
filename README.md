...
- 💬 **Ask me about:** Python, SQL, Power BI, DAX, Scikit-Learn, OpenCV, and Data Storytelling
...
![DAX](https://img.shields.io/badge/DAX-Query-0078D4?style=for-the-badge&logo=microsoft&logoColor=white)
...
| :--- | :--- | :---: |
| 🌾 **Rice Grain Classification** | Classified 5 grain varieties with **96.99% accuracy** using OpenCV feature extraction & KNN. | [View Repo](https://github.com/shrivaradb/Rice-Grain-Classification) |
| 📊 **Blinkit Sales Performance Dashboard** | Comprehensive Power BI BI dashboard tracking sales KPIs, outlet performance & customer ratings. | [View Repo](https://github.com/shrivaradb/Blinkit-Sales-Performance-Dashboard) |
| 📉 **Telecom Customer Churn Dashboard** | Customer segmentation and churn driver analysis with interactive DAX KPI metrics. | [View Repo](https://github.com/shrivaradb/Telecom-Customer-Churn-Analysis-Dashboard) |
| 👤 **Face Recognition Attendance System** | Real-time webcam-based attendance logging system with Python, OpenCV, and `face_recognition`. | [View Repo](https://github.com/shrivaradb/Face-Recognition-Based-Attendance-System) |
